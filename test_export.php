...
for ($i=0; $i < TOTAL_RUNS; $i++) { 
    ...
    $start = microtime(true);
    $result = mysqli_query($connMysql, "SELECT * FROM answers INTO OUTFILE 'C:\/ProgramData/MySQL/MySQL Server 8.0/Uploads/" .time() . ".csv' FIELDS ENCLOSED BY '\"' TERMINATED BY ',' ESCAPED BY '\"' LINES TERMINATED BY '\n';");
    $end = microtime(true);
